...
angular.module('attendances').controller('AttendancesController', ['$scope', '$stateParams', '$http', '$location', 'Attendances', '$modal', '$log',
	function($scope, $stateParams, $http, $location, Attendances, $modal, $log) {
